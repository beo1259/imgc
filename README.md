# imgc
**Fast and easy image conversion, all from the command line**
...
```$ imgc conv -i imagetoconvert.png -t jpg```
####  With output flag (saves to specified output directory)
```$ imgc conv -i imagetoconvert.png -t jpg -o C:/Downloads```

## Questions
**Contact me at oneilb123@gmail.com**
